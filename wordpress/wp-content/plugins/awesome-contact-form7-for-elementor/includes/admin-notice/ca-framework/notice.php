<?php 
namespace TB_Framework;

if ( ! defined( 'ABSPATH' ) ) {
	exit;
}

if( ! class_exists( 'TB_Framework\Notice' ) ){
    ...
    class Notice
    {
        ...
        public $notice_type = 'ca-success';
        public $notice_style = 'notice';
        private $img;
        ...
        public function set_style( $notice_style )
        {
        ...
        ?>
        <div data-notice_id="<?php echo $this->notice_id; ?>" class='<?php echo esc_attr( $this->notice_style ); ?> ca-notice <?php echo esc_attr( $this->notice_type ); ?>'>
